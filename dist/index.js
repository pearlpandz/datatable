...
var css_248z$5 = ".table-data,.table-data .link{font-size:16px;font-weight:300;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.table-data .link{color:#00e;cursor:pointer;text-decoration:underline}";
...
var css_248z$2 = ".column-filter-main{cursor:pointer;margin-right:4px;position:relative;z-index:1}.filter-icon{background:none;color:#343a40;display:-webkit-box;display:-ms-flexbox;display:flex;height:16px;vertical-align:middle;width:16px}.filter-dropdown{background-color:#fff;border:0;border-radius:6px;-webkit-box-shadow:0 2px 12px 0 rgba(0,0,0,.1);box-shadow:0 2px 12px 0 rgba(0,0,0,.1);color:#495057;min-width:280px;position:fixed}#datatable thead th:first-child .filter-dropdown{left:0;min-width:280px;width:240px}#datatable thead th:last-child .filter-dropdown{left:auto!important;min-width:280px;right:20px!important;width:240px}.filter-icon-section:has(.active){background:#be2bbb;border-radius:50%;display:inline-block;padding:5px}.filter-icon.active{filter:url('data:image/svg+xml;charset=utf-8,<svg xmlns=\"http://www.w3.org/2000/svg\"><filter id=\"filter\"><feComponentTransfer color-interpolation-filters=\"sRGB\"><feFuncR type=\"table\" tableValues=\"1 0\" /><feFuncG type=\"table\" tableValues=\"1 0\" /><feFuncB type=\"table\" tableValues=\"1 0\" /></feComponentTransfer></filter></svg>#filter');-webkit-filter:invert(1);filter:invert(1)}.custom-dropdown,.custom-dropdown-2{border-top-left-radius:6px;border-top-right-radius:6px;color:#343a40;display:inline-block;margin:0;position:relative;width:100%}.operator-dropdown-section{background:#f8f9fa;border-bottom:1px solid #dee2e6;border-top-left-radius:6px;border-top-right-radius:6px;color:#343a40;margin:0;padding:10px 15px}.dropdown-container{border:1px solid #ccc;border-radius:5px;position:relative;text-align:left}.dropdown-input{-webkit-box-align:center;-ms-flex-align:center;-webkit-box-pack:justify;-ms-flex-pack:justify;align-items:center;background-color:#fff;border:1px solid #ced4da;border-radius:6px;display:-webkit-box;display:-ms-flexbox;display:flex;height:40px;justify-content:space-between;padding:5px}.dropdown-input:focus,.dropdown-input:hover{border-color:#be2bbb}.dropdown-menu{background-color:#fff;border:1px solid #ccc;border-radius:5px;max-height:160px;overflow:auto;padding:12px 0;position:absolute;-webkit-transform:translateY(0);transform:translateY(0);width:100%;z-index:99}.dropdown-item{cursor:pointer;padding:5px}.dropdown-item:hover{background-color:rgba(159,195,248,.439)}.dropdown-item.selected{background-color:#0d6efd;color:#fff}.dropdown-tags{-ms-flex-wrap:wrap;flex-wrap:wrap;gap:5px}.dropdown-tag-item,.dropdown-tags{display:-webkit-box;display:-ms-flexbox;display:flex}.dropdown-tag-item{-webkit-box-align:center;-ms-flex-align:center;align-items:center;background-color:#ddd;border-radius:2px;padding:2px 4px}.Matchmode-Section{color:#343a40;margin:0}.filter-input-text{-webkit-appearance:none;-moz-appearance:none;appearance:none;background:#fff;border:1px solid #ced4da;border-radius:6px;color:#495057;font-size:15px;height:40px;margin-top:8px;padding:12px;-webkit-transition:background-color .2s,color .2s,border-color .2s,-webkit-box-shadow .2s;transition:background-color .2s,color .2s,border-color .2s,-webkit-box-shadow .2s;transition:background-color .2s,color .2s,border-color .2s,box-shadow .2s;transition:background-color .2s,color .2s,border-color .2s,box-shadow .2s,-webkit-box-shadow .2s;width:100%}.add-rule{color:#6366f1}.add-rule,.remove-rule{background-color:#fff;border:none;cursor:pointer;font-size:14px;margin-top:8px;width:100%}.remove-rule{color:#ef4444}.add-rule:hover{background:rgba(99,102,241,.04);border-color:transparent;color:#6366f1}.remove-rule:hover{background:rgba(239,68,68,.04);border-color:transparent;color:#ef4444}.filter-footer-button{background-color:#fff;border:1px solid #be2bbb;border-radius:5px;color:#be2bbb;cursor:pointer;padding:5.5px 17.5px}.primary{background-color:#be2bbb;color:#fff}.option-label{color:#495057;cursor:pointer;display:-webkit-box;display:-ms-flexbox;display:flex;font-size:16px;font-weight:400;overflow:hidden;padding:12px 20px;position:relative;white-space:nowrap}.option-label.selected{background:#eef2ff;color:#4338ca}.option-label:hover{background:#e9ecef;color:#495057}.section-alignment{background:#fff;padding:5px 15px}.Multi-section{background:#fff}.column-footer-buttons{-webkit-box-align:center;-ms-flex-align:center;-webkit-box-pack:justify;-ms-flex-pack:justify;align-items:center;background:#fff;cursor:auto;display:-webkit-box;display:-ms-flexbox;display:flex;justify-content:space-between;padding:25px}.dropdown-selected-value{color:#495057;font-size:15px;font-weight:400;padding:12px}.dropdown-Icon{height:20px;width:20px}.dropdown-tools{position:relative;right:10px;top:3px}.custom-dropdown:has(.dropdown-menu),.custom-dropdown:hover .dropdown-menu{display:block}.dropdown-menu{display:none}";
...
var css_248z$1 = ".infinite_loader{-webkit-animation:spin 2s linear infinite;animation:spin 2s linear infinite;border:3px solid #f3f3f3;border-radius:50%;border-top-color:#dee2e6;height:40px;width:40px}@-webkit-keyframes spin{0%{-webkit-transform:rotate(0deg)}to{-webkit-transform:rotate(1turn)}}@keyframes spin{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}to{-webkit-transform:rotate(1turn);transform:rotate(1turn)}}";
...
var css_248z = ".dataTable{border-collapse:collapse;position:relative}.dataTable th{background-color:#eee7e7;padding:7px 15px;position:relative}.dataTable tbody tr,.dataTable thead{table-layout:fixed;width:100%}.dataTable th .resizer:last-child{display:none}table td{padding:0 15px}table tr:nth-child(2n){background-color:#fcfafa}.resizer{background-color:#fff;cursor:col-resize;height:35px;position:absolute;right:0;top:0;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;width:2px}.resizable{border:1px solid gray;height:100px;position:relative;width:100px}#dataTable-parent_Freeze{display:grid;height:calc(100vh - 175px);overflow-x:auto}#dataTable-parent{display:grid;min-height:calc(100vh - 175px);overflow-x:auto}.dataTable.Header_freeze{height:100%}.dataTable.Header_freeze thead th{position:sticky;top:0}.action-template{-webkit-box-align:center;-ms-flex-align:center;align-items:center;color:#be2bbb;display:-webkit-box;display:-ms-flexbox;display:flex;font-size:16px;font-weight:300;position:unset;vertical-align:middle;white-space:nowrap}.action-label{padding:12px 20px}#datatable tr{height:45px!important}.action-label:hover{text-decoration:underline}.datatable-body-parent{position:relative}.datatable-head-parent{position:sticky;top:0;z-index:1}.no-datatable{border-spacing:0;color:#495057;font-size:20px;height:350px;text-align:center;white-space:nowrap}.datatable-checkbox{background-color:#fff;border:1.4px solid #ced4da;border-radius:2px;cursor:pointer;height:18px;outline:none;width:18px}.datatable-checkbox:after{background-color:#be2bbb;visibility:visible}.datatable-checkbox:checked:after{border-radius:2px;color:#fff;content:\"\\2714\";display:block;font-size:10px;font-weight:700;height:16px;padding-top:2px;text-align:center;width:18px}.expander{background:transparent;border:0;cursor:pointer;font-size:24px}";
